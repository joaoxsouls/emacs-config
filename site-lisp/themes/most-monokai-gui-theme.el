...
(let ((monokai-blue-light "#89BDFF")
  ...
  (custom-theme-set-faces
   ...
   ;; Frame
   `(default ((t (:foreground ,monokai-grey :background ,monokai-grey-dark))))
   `(cursor ((t (:foreground ,monokai-magenta))))
   `(hl-line ((t (:background ,monokai-gray-darkest))))
   `(minibuffer-prompt ((t (:foreground ,monokai-magenta))))
   ...
   `(font-lock-function-name-face ((t (:foreground ,monokai-magenta))))
   `(font-lock-keyword-face ((t (:foreground ,monokai-blue-light))))
   `(font-lock-string-face ((t (:foreground ,monokai-yellow))))
   `(font-lock-type-face ((t (:underline t :foreground ,monokai-cyan))))
...
(provide-theme 'most-monokai-gui)
